...
#define HCI_SCO_FLAGS_PACKET_STATUS_MASK_POSSIBLY_INVALID_DATA          0x4000
#define HCI_SCO_FLAGS_PACKET_STATUS_MASK_NO_DATA_RECEIVED               0x8000
#define HCI_SCO_FLAGS_PACKET_STATUS_MASK_DATA_PARTIALLY_LOST            0xC000
