...
#define OBEX_PACKET_LENGTH_MAXIMUM                                     65535
   ...
   /* Constant value.                                                   */
#define SDP_ASSIGN_OBEX_UUID_16(_x)             ASSIGN_UUID_16((_x), 0x00, 0x08)
   ...
   /* Constant value.                                                   */
#define SDP_ASSIGN_OBEX_UUID_32(_x)             ASSIGN_UUID_32((_x), 0x00, 0x00, 0x00, 0x08)
...
#define SDP_ASSIGN_OBEX_UUID_128(_x)            ASSIGN_UUID_128((_x), 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)
