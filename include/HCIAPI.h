...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_HCI_User_Confirmation_Request_Reply_t)(unsigned int BluetoothStackID, Byte_t *StatusResult, BD_ADDR_t BD_ADDR, BD_ADDR_t *BD_ADDRResult);
#endif
...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_HCI_Logical_Link_Cancel_t)(unsigned int BluetoothStackID, Byte_t Physical_Link_Handle, Byte_t Flow_Spec_ID, Byte_t *StatusResult, Byte_t *Physical_Link_HandleResult, Byte_t *Flow_Spec_IDResult);
#endif
...
BTPSAPI_DECLARATION int BTPSAPI HCI_Read_Country_Code(unsigned int BluetoothStackID, Byte_t *StatusResult, Byte_t *Country_CodeResult);
   ...
   /* StatusResult variable will contain the Status Result returned from*/
   /* the Bluetooth Device AND the BD_ADDRResult variable will contain  */
   /* the Country Code Result returned from the Bluetooth Device.       */
   /* * NOTE * This function blocks until either a result is returned   */
   /*          from the Bluetooth Device OR the function Times Out      */
   /*          Waiting for a response from the Bluetooth Device.        */
