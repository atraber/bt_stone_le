...
#define SDP_ASSIGN_SERIAL_PORT_PROFILE_UUID_16(_x)  ASSIGN_UUID_16((_x), 0x11, 0x01)
...
#define SDP_ASSIGN_SERIAL_PORT_PROFILE_UUID_32(_x)  ASSIGN_UUID_32((_x), 0x00, 0x00, 0x11, 0x01)
...
#define SDP_ASSIGN_SERIAL_PORT_PROFILE_UUID_128(_x) ASSIGN_UUID_128((_x), 0x00, 0x00, 0x11, 0x01, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)
...
BTPSAPI_DECLARATION int BTPSAPI SPP_Get_Queuing_Parameters(unsigned int BluetoothStackID, unsigned int *MaximumNumberDataPackets, unsigned int *QueuedDataPacketsThreshold);
   ...
   /*          Numbers !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
BTPSAPI_DECLARATION int BTPSAPI SPP_Query_Server_Present(unsigned int BluetoothStackID, Byte_t ServerPort, Boolean_t *ServerPresent);

#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_SPP_Query_Server_Present_t)(unsigned int BluetoothStackID, Byte_t ServerPort, Boolean_t *ServerPresent);
#endif
