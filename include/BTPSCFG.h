/*****< btpscfg.h >************************************************************/
/*      Copyright 2009 - 2012 Stonestreet One.                                */
/*      All Rights Reserved.                                                  */
/*                                                                            */
...
#define BTPS_CONFIGURATION_TIMER_MAXIMUM_NUMBER_CONCURRENT_TIMERS             6
...
#define BTPS_CONFIGURATION_TIMER_MINIMUM_TIMER_RESOLUTION_MS                 50
   ...
   /*          received.                                                */
#define BTPS_CONFIGURATION_HCI_DRIVER_RECEIVE_PACKET_BUFFER_SIZE           (HCI_CALCULATE_ACL_DATA_SIZE(256))
...
#define BTPS_CONFIGURATION_HCI_MAXIMUM_SUPPORTED_HCI_PACKET_SIZE           (HCI_CALCULATE_ACL_DATA_SIZE(256))
#define BTPS_CONFIGURATION_HCI_SYNCHRONOUS_WAIT_TIMEOUT_MS                 5000
#define BTPS_CONFIGURATION_HCI_DISPATCH_THREAD_STACK_SIZE                  1100
#define BTPS_CONFIGURATION_HCI_NUMBER_DISPATCH_MAILBOX_SLOTS               16
...
#define BTPS_CONFIGURATION_RFCOMM_DEFAULT_MAXIMUM_NUMBER_QUEUED_DATA_PACKETS  1
...
#define BTPS_CONFIGURATION_SPP_DEFAULT_TRANSMIT_BUFFER_SIZE               (38*1)
#define BTPS_CONFIGURATION_SPP_DEFAULT_RECEIVE_BUFFER_SIZE                (38*1)
#define BTPS_CONFIGURATION_SPP_DEFAULT_FRAME_SIZE                         ((38 > SPP_FRAME_SIZE_MAXIMUM)?SPP_FRAME_SIZE_MAXIMUM:38)
...
#define BTPS_CONFIGURATION_GATT_SUPPORT_READ_MULTIPLE_REQUEST             0
#define BTPS_CONFIGURATION_GATT_SUPPORT_WRITE_COMMAND                     1
#define BTPS_CONFIGURATION_GATT_SUPPORT_SIGNED_WRITE_COMMAND              0
#define BTPS_CONFIGURATION_GATT_SUPPORT_WRITE_REQUEST                     1
#define BTPS_CONFIGURATION_GATT_SUPPORT_PREPARE_WRITE_REQUEST             0
...
#define BTPS_CONFIGURATION_GAPS_SUPPORT_PREFERRED_CONNECTION_PARAMETERS   0

   /* GLS Configuration.                                                */
#define BTPS_CONFIGURATION_GLS_MAXIMUM_SUPPORTED_INSTANCES                1
#define BTPS_CONFIGURATION_GLS_SUPPORT_MEASUREMENT_CONTEXT                1
#define BTPS_CONFIGURATION_GLS_SUPPORT_DATE_TIME                          1
