...
#define RFCOMM_BREAK_SIGNAL_MAXIMUM                                        0x0F
   ...
   /* Constant value.                                                   */
#define SDP_ASSIGN_RFCOMM_UUID_16(_x)           ASSIGN_UUID_16((_x), 0x00, 0x03)
   ...
   /* Constant value.                                                   */
#define SDP_ASSIGN_RFCOMM_UUID_32(_x)           ASSIGN_UUID_32((_x), 0x00, 0x00, 0x00, 0x03)
...
#define SDP_ASSIGN_RFCOMM_UUID_128(_x)          ASSIGN_UUID_128((_x), 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)
