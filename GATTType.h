...
#include "BTTypes.h"            /* Bluetooth Type Definitions.                */
   ...
   /* Endian Format.                                                    */
#define COMPARE_UUID_16_TO_CONSTANT(_x, _a, _b)              \
(                                                            \
   ((_x).UUID_Byte0  == (_a))  && ((_x).UUID_Byte1  == (_b)) \
)
...
#define COMPARE_UUID_128_TO_CONSTANT(_x, _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p)    \
(                                                                                                           \
   ((_x).UUID_Byte0  == (_a)) && ((_x).UUID_Byte1  == (_b)) && ((_x).UUID_Byte2  == (_c)) &&                \
   ((_x).UUID_Byte3  == (_d)) && ((_x).UUID_Byte4  == (_e)) && ((_x).UUID_Byte5  == (_f)) &&                \
   ((_x).UUID_Byte6  == (_g)) && ((_x).UUID_Byte7  == (_h)) && ((_x).UUID_Byte8  == (_i)) &&                \
   ((_x).UUID_Byte9  == (_j)) && ((_x).UUID_Byte10 == (_k)) && ((_x).UUID_Byte11 == (_l)) &&                \
   ((_x).UUID_Byte12 == (_m)) && ((_x).UUID_Byte13 == (_n)) && ((_x).UUID_Byte14 == (_o)) &&                \
   ((_x).UUID_Byte15 == (_p))                                                                               \
)
...
#define CONVERT_UUID_16_TO_UUID_128(_x,_y)               ASSIGN_UUID_128((_x), 0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, (_y).UUID_Byte1, (_y).UUID_Byte0, 0x00, 0x00)
...
#define COMPARE_UUID_128_TO_UUID_16_CONSTANT(_x, _a, _b)   COMPARE_UUID_128_TO_CONSTANT((_x), 0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, (_b), (_a), 0x00, 0x00)
   ...
   /* than/greater than.                                                */
#define COMPARE_UUID_128_TO_UUID_16(_x,_y)               COMPARE_UUID_128_TO_CONSTANT((_x), 0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, (_y).UUID_Byte1, (_y).UUID_Byte0, 0x00, 0x00)
...
#define GATT_ASSIGN_PRIMARY_SERVICE_ATTRIBUTE_TYPE(_x)   ASSIGN_UUID_16((_x), 0x00, 0x28)
...
#define GATT_COMPARE_PRIMARY_SERVICE_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x00, 0x28)
   ...
   /* less than/greater than. The first parameter is the UUID_16_t      */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_PRIMARY_SERVICE_ATTRIBUTE_TYPE_TO_UUID_128(_x) COMPARE_UUID_128_TO_UUID_16_CONSTANT((_x), 0x00, 0x28)
   ...
   /* ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This MACRO assigns the */
   /* GATT Service UUID 16.                                             */
#define GATT_ASSIGN_SECONDARY_SERVICE_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x01, 0x28)
   ...
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_SECONDARY_SERVICE_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x01, 0x28)
   ...
   /* NOT less than/greater than. The first parameter is the UUID_16_t  */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_SECONDARY_SERVICE_ATTRIBUTE_TYPE_TO_UUID_128(_x) COMPARE_UUID_128_TO_UUID_16_CONSTANT((_x), 0x01, 0x28)
   ...
   /* ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This MACRO assigns the */
   /* GATT Service UUID 16.                                             */
#define GATT_ASSIGN_INCLUDE_ATTRIBUTE_TYPE(_x)           ASSIGN_UUID_16((_x), 0x02, 0x28)
   ...
   /* NOT less than/greater than. The first parameter is the UUID_16_t  */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_INCLUDE_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x02, 0x28)
   ...
   /* NOT less than/greater than. The first parameter is the UUID_16_t  */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_INCLUDE_ATTRIBUTE_TYPE_TO_UUID_128(_x) COMPARE_UUID_128_TO_UUID_16_CONSTANT((_x), 0x02, 0x28)
   ...
   /* ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This MACRO assigns the */
   /* GATT Service UUID 16.                                             */
#define GATT_ASSIGN_CHARACTERISTIC_ATTRIBUTE_TYPE(_x)    ASSIGN_UUID_16((_x), 0x03, 0x28)
   ...
   /* NOT less than/greater than. The first parameter is the UUID_16_t  */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_CHARACTERISTIC_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x03, 0x28)
   ...
   /* NOT less than/greater than. The first parameter is the UUID_16_t  */
   /* variable to compare to the GATT Primary Service UUID.             */
#define GATT_COMPARE_CHARACTERISTIC_ATTRIBUTE_TYPE_TO_UUID_128(_x) COMPARE_UUID_128_TO_UUID_16_CONSTANT((_x), 0x03, 0x28)
...
#define GATT_ASSIGN_CHARACTERISTIC_EXTENDED_PROPERTIES_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x00, 0x29)
...
#define GATT_COMPARE_CHARACTERISTIC_EXTENDED_PROPERTIES_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x00, 0x29)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_CHARACTERISTIC_USER_DESCRIPTION_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x01, 0x29)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_CHARACTERISTIC_USER_DESCRIPTION_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x01, 0x29)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_CLIENT_CHARACTERISTIC_CONFIGURATION_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x02, 0x29)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_CLIENT_CHARACTERISTIC_CONFIGURATION_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x02, 0x29)

   /* The following defines the GATT Client Characteristic Configuration*/
   /* UUID that is used when building the service tables.               */
#define GATT_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_CONSTANT { 0x02, 0x29 }

   /* The following defines the valid length of the GATT Client         */
   /* Characteristic Configuration descriptor.                          */
#define GATT_CLIENT_CHARACTERISTIC_CONFIGURATION_LENGTH  (WORD_SIZE)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_SERVER_CHARACTERISTIC_CONFIGURATION_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x03, 0x29)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_SERVER_CHARACTERISTIC_CONFIGURATION_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x03, 0x29)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_CHARACTERISTIC_FORMAT_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x04, 0x29)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_CHARACTERISTIC_FORMAT_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x04, 0x29)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_CHARACTERISTIC_AGGREGATE_FORMAT_ATTRIBUTE_TYPE(_x) ASSIGN_UUID_16((_x), 0x05, 0x29)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_CHARACTERISTIC_AGGREGATE_FORMAT_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x05, 0x29)
   ...
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_GATT_SERVICE_UUID(_x)                ASSIGN_UUID_16((_x), 0x01, 0x18)
...
#define GATT_COMPARE_GATT_SERVICE_UUID_TO_UUID_16(_x)    COMPARE_UUID_16_TO_CONSTANT((_x), 0x01, 0x18)

   /* The following defines the GATT Service UUID that is used when     */
   /* building the GATT Service Table.                                  */
#define GATT_SERVICE_UUID_CONSTANT                       { 0x01, 0x18 }
...
#define SDP_ASSIGN_GATT_UUID_16(_x)                      ASSIGN_UUID_16((_x), 0x18, 0x01)
   ...
   /* receive the GATT Service UUID (for SDP).  This MACRO assigns the  */
   /* GATT Service UUID 16 (in Big Endian format).                      */
#define SDP_ASSIGN_ATT_UUID_16(_x)                     ASSIGN_UUID_16((_x), 0x00, 0x07)
   ...
   /* is to receive the ATTRIBUTE_PROTOCOL_UUID_16 Constant value. This */
   /* MACRO assigns the GATT Service UUID 16.                           */
#define GATT_ASSIGN_SERVICE_CHANGED_ATTRIBUTE_TYPE(_x)   ASSIGN_UUID_16((_x), 0x05, 0x2A)
   ...
   /* parameter is the UUID_16_t variable to compare to the GATT        */
   /* Primary Service UUID.                                             */
#define GATT_COMPARE_SERVICE_CHANGED_ATTRIBUTE_TYPE_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x05, 0x2A)

   /* The following defines the GATT Service Changed UUID that is used  */
   /* when building the GATT Service Table.                             */
#define GATT_SERVICE_CHANGED_UUID_CONSTANT               { 0x05, 0x2A }
