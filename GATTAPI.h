...
#define BTGATT_ERROR_CHANNEL_MTU_EXCEEDED                          (-1008)
#define BTGATT_ERROR_INVALID_HANDLE_VALUE                          (-1009)
#define BTGATT_ERROR_INVALID_CONNECTION_ID                         (-1010)
#define BTGATT_ERROR_REGISTERING_FIXED_CHANNEL                     (-1011)
#define BTGATT_ERROR_OUTSTANDING_REQUEST_EXISTS                    (-1012)
#define BTGATT_ERROR_OUTSTANDING_INDICATION_EXISTS                 (-1013)
#define BTGATT_ERROR_INVALID_SERVICE_RECORD_HANDLE                 (-1014)
#define BTGATT_ERROR_INVALID_ATTRIBUTE_ENTRY_SIZE                  (-1015)
#define BTGATT_ERROR_INVALID_CALLBACK_ALREADY_REGISTERED           (-1016)
#define BTGATT_ERROR_INVALID_SERVICE_TABLE_FORMAT                  (-1017)
#define BTGATT_ERROR_INVALID_TRANSACTION_ID                        (-1018)
#define BTGATT_ERROR_INSUFFICIENT_HANDLES                          (-1019)
...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_GATT_Register_Service_t)(unsigned int BluetoothStackID, Byte_t Service_Flags, unsigned int NumberOfServiceAttributeEntries, GATT_Service_Attribute_Entry_t *ServiceTable, GATT_Attribute_Handle_Group_t *ServiceHandleGroupResult, GATT_Server_Event_Callback_t ServerEventCallback, unsigned long CallbackParameter);
#endif
...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_GATT_Service_Changed_Read_Response_t)(unsigned int BluetoothStackID, unsigned int TransactionID, GATT_Service_Changed_Data_t *ServiceChangedData);
#endif
...
#ifdef INCLUDE_BLUETOOTH_API_PROTOTYPES
   typedef int (BTPSAPI *PFN_GATT_Service_Changed_Indication_t)(unsigned int BluetoothStackID, unsigned int ConnectionID, GATT_Service_Changed_Data_t *ServiceChangedData);
#endif
