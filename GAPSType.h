...
#define GAP_ASSIGN_GAP_SERVICE_UUID_16(_x)               ASSIGN_UUID_16((_x), 0x00, 0x18)
...
#define GAP_COMPARE_GAP_SERVICE_UUID_TO_UUID_16(_x)      COMPARE_UUID_16_TO_CONSTANT((_x), 0x00, 0x18)

   /* The following defines the GAP Service UUID that is used when      */
   /* building the GAPS Service Table.                                  */
#define GAP_SERVICE_UUID_CONSTANT                        { 0x00, 0x18 }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define GAP_ASSIGN_DEVICE_NAME_UUID16(_x)                ASSIGN_UUID_16((_x), 0x00, 0x2A)
...
#define GAP_COMPARE_GAP_DEVICE_NAME_UUID_TO_UUID_16(_x)  COMPARE_UUID_16_TO_CONSTANT((_x), 0x00, 0x2A)
   
   /* The following defines the GAP Device Name Characteristic UUID that*/
   /* is used when building the GAP Service Table.                      */
#define GAP_DEVICE_NAME_CHARACTERISTIC_UUID_CONSTANT     { 0x00, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define GAP_ASSIGN_DEVICE_APPEARENCE_UUID16(_x)                ASSIGN_UUID_16((_x), 0x01, 0x2A)
...
#define GAP_COMPARE_GAP_DEVICE_APPEARANCE_UUID_TO_UUID_16(_x)  COMPARE_UUID_16_TO_CONSTANT((_x), 0x01, 0x2A)
   
   /* The following defines the GAP Device Appearance Characteristic    */
   /* UUID that is used when building the GAP Service Table.            */
#define GAP_DEVICE_APPEARANCE_CHARACTERISTIC_UUID_CONSTANT     { 0x01, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define GAP_ASSIGN_PERIPHERAL_PRIVACY_FLAG_UUID16(_x)                ASSIGN_UUID_16((_x), 0x02, 0x2A)
   ...
   /* Flag UUID.                                                        */
#define GAP_COMPARE_GAP_PERIPHERAL_PRIVACY_FLAG_UUID_TO_UUID_16(_x)  COMPARE_UUID_16_TO_CONSTANT((_x), 0x02, 0x2A)
   
   /* The following defines the GAP Peripheral Privacy Flag             */
   /* Characteristic UUID that is used when building the GAP Service    */
   /* Table.                                                            */
#define GAP_PERIPHERAL_PRIVACY_FLAG_CHARACTERISTIC_UUID_CONSTANT     { 0x02, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define GAP_ASSIGN_RECONNECTION_ADDRESS_UUID16(_x)                ASSIGN_UUID_16((_x), 0x03, 0x2A)
   ...
   /* UUID.                                                             */
#define GAP_COMPARE_GAP_RECONNECTION_ADDRESS_UUID_TO_UUID_16(_x)  COMPARE_UUID_16_TO_CONSTANT((_x), 0x03, 0x2A)
   
   /* The following defines the GAP Reconnection Address Characteristic */
   /* UUID that is used when building the GAP Service Table.            */
#define GAP_RECONNECTION_ADDRESS_CHARACTERISTIC_UUID_CONSTANT     { 0x03, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define GAP_ASSIGN_PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS_UUID16(_x)                ASSIGN_UUID_16((_x), 0x04, 0x2A)
   ...
   /* UUID.                                                             */
#define GAP_COMPARE_GAP_PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS_UUID_TO_UUID_16(_x)  COMPARE_UUID_16_TO_CONSTANT((_x), 0x04, 0x2A)
...
#define GAP_PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS_CHARACTERISTIC_UUID_CONSTANT     { 0x04, 0x2A }
...
#define GAP_DEVICE_APPEARENCE_VALUE_LENGTH               (WORD_SIZE)
   ...
   /* The following MACRO is a utility MACRO that is used to validate   */
   /* the length of a Write into the Device Appearence Characteristic   */
   /* (if it is writable).  The only parameter to this MACRO is the     */
   /* length of the Value that is being written.                        */
#define GAP_DEVICE_APPEARENCE_VALID_LENGTH(_x)           ((_x) == GAP_DEVICE_APPEARENCE_VALUE_LENGTH)

   /* The followings defines the Reconnection Address Characteristic    */
   /* Value Length.                                                     */
#define GAP_RECONNECTION_ADDRESS_VALUE_LENGTH(_x)        (BD_ADDR_SIZE)

   /* The following MACRO is a utility MACRO that is used to validate   */
   /* the length of a Write into the Reconnection Address Characteristic*/
   /* (if it is writable).  The only parameter to this MACRO is the     */
   /* length of the Value that is being written.                        */
#define GAP_RECONNECTION_ADDRESS_VALID_LENGTH(_x)        ((_x) == GAP_RECONNECTION_ADDRESS_VALUE_LENGTH)
